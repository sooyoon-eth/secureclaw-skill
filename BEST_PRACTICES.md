...
- **Run `secureclaw --audit`:** (If the CLI component is installed) Use the deployment hardening command to automatically scan your configuration for these weaknesses and remove unauthorized tools.
